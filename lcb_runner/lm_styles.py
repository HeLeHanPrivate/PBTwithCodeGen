...
LanguageModelList: list[LanguageModel] = [
    ...
    # LocalAPI: add your own OpenAI-compatible endpoint here.
    # The examples below use the standard local vLLM default port.
    ...
    LanguageModel(
        ...
        LMStyle.CodeQwenInstruct,
        datetime(2024, 6, 30),
        link="model/Qwen2.5-Coder-7B-Instruct",
    ),
    LanguageModel(
        ...
        LMStyle.CodeQwenInstruct,
        datetime(2024, 6, 30),
        link="model/Qwen3-Coder-30B-Instruct",
    ),
]
